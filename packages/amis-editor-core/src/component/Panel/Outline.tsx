...
export class OutlinePanel extends React.Component<PanelProps> {
  ...
  renderItem(
    ...
    } else if (type === 'dialogView') {
      children = (
        !store.dragging && option.dialogViewSingleRegion
          ? option.uniqueDialogViewChildren[0]!.uniqueDialogViewChildren
          : option.uniqueDialogViewChildren
      ) as Array<EditorNodeType>;
    } else {
      children = (
